...
//        memberInSameGroup.removeIf(member -> member.getId().equals(loggedInMemberId));
    ...
    public Page<Group> getAdminGroupPage(GroupSearchDto searchDto, Long groupId, Pageable pageable) {
        return groupRepository.getAdminGroupPage(searchDto, groupId, pageable);
    }
}