...
//                .sorted(Comparator.comparing(NoticeBoard::getCreatedAt).reversed()) // 생성일자를 기준으로 내림차순 정렬
...
//        int endIndex = Math.min(startIndex + pageSize, noticeBoards.size());
//
//        if (startIndex >= endIndex) {
//            endIndex = startIndex;
//        }
//
//        List<NoticeBoard> pagedNoticeBoards = noticeBoards.subList(startIndex, endIndex);
//
//
//        model.addAttribute("pagedNoticeBoards", pagedNoticeBoards);
//        model.addAttribute("pageNumber", pageNumber);
//        model.addAttribute("totalPages", (int) Math.ceil((double) noticeBoards.size() / pageSize));
//
//        System.out.println("pagedNoticeBoards: " + pagedNoticeBoards);
//
//        model.addAttribute("noticeBoards", pagedNoticeBoards); // 수정된 부분
